...
class F3Reference:
    ...
    LinkWikiName: str=""         # The wiki name of the page being linked to if it is a link to Fancy 3 (else None)
                                            # Note that this not the wiki page's canonical name.
    LinkDisplayText: str=""   # The text actually used on the page for the link [[the stuff between the brackets]]
